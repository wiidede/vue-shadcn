...
export default defineConfig({
  shortcuts: [
    ['btn', 'px-4 py-1 rounded inline-block bg-primary-700 text-white cursor-pointer !outline-none hover:bg-primary-800 disabled:cursor-default disabled:bg-gray-600 disabled:opacity-50'],
